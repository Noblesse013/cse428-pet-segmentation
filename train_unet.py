"""
Training script for Base U-Net (segmentation + breed classification).
...
Produces:
    ...
    results/unet_loss_curves.png
    results/unet_seg_curves.png
    results/unet_cls_curves.png
"""
...
def main(
    ...
    # ── Model ───────────────────────────────────────────────────────────
    model = BaseUNet(in_channels=3, num_classes=num_classes, base_features=base_features)
    ...
    plot_all_curves(history, str(RESULTS_DIR), prefix="unet")
